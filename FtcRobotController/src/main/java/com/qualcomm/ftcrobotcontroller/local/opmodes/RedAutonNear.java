...
public class RedAutonNear extends LinearOpMode{
    ...
    Servo   S_climbersKnockdownR    = null, // right servo that knocks down climbers
            ...
            S_buttonPusher          = null; // servo thatpushes button
    ...
    final double    S_CLIMBERS_DEPOSIT_ROTATE_END_POS   = 0.996d,
                    S_climbers_DEPOSIT_DROP_END_POS     = Servo.MIN_POSITION,
                    S_BUTTON_PUSHER_END_POS             = 0.996d;
